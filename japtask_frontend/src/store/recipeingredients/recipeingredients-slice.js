...
export const getRecipeIngredients = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      return await recipeIngredientService.getRecipeIngredients(id, token);
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
...
export const updateRecipeIngredients = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const token = thunkAPI.getState().auth.user.data;
      return await recipeIngredientService.updateRecipeIngredients(data, token);
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
...
export const deleteRecipeIngredients = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const token = thunkAPI.getState().auth.user.data;
      return await recipeIngredientService.deleteRecipeIngredients(data, token);
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
